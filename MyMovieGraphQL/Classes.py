...
class AdditionalResumeInfo:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('title'):
            ...
            self.title = None
    def __str__(self):
        if self.title and self.details:
        ...
        return ""
    def __repr__(self):
        return f"AdditionalResumeInfo(details={self.details}, id={self.id}, title={self.title})"
    def __eq__(self, other):
...
class AdvancedNameSearchResult:
    ...
    def __repr__(self):
        return self.name.__repr__() if self.name else "AdvancedNameSearchResult(name=None)"
    def __eq__(self, other):
...
class AdvancedTitleSearchResult:
    ...
    def __repr__(self):
        return self.title.__repr__() if self.title else "AdvancedTitleSearchResult(title=None)"
    def __eq__(self, other):
...
class Agent:
    ...
    def __str__(self):
        ...
        return string
    def __repr__(self):
        return f"Agent(branch={self.branch}, company={self.company}, employeeContact={self.employeeContact}, id={self.id}, isPrimaryAgent={self.isPrimaryAgent}, jobTitle={self.jobTitle}, name={self.name}, occupation={self.occupation}, relationshipType={self.relationshipType})"
    def __eq__(self, other):
...
class AggregateRatingsBreakdown:
    ...
    def __str__(self):
        return str(self.histogram) if self.histogram else ""
    def __repr__(self):
        return f"AggregateRatingsBreakdown(histogram={self.histogram}, isCollapsed={self.isCollapsed}, ratingsSummaryByCountry={self.ratingsSummaryByCountry}, ratingsSummaryByDemographics={self.ratingsSummaryByDemographics})"
    def __eq__(self, other):
...
class Aka:
    ...
    def __repr__(self):
        return f"Aka(attributes={self.attributes}, country={self.country}, displayableProperty={self.displayableProperty}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class AlexaQuestion:
    ...
    def __str__(self):
        ...
        return ""
    def __repr__(self):
        return f"AlexaQuestion(answer={self.answer}, attributeId={self.attributeId}, question={self.question})"
    def __eq__(self, other):
...
class AlternateVersion:
    ...
    def __repr__(self):
        return f"AlternateVersion(displayableArticle={self.displayableArticle}, text={self.text})"
    def __eq__(self, other):
...
class AmazonMusicProduct:
    ...
    def __str__(self):
        if self.productTitle and self.artists and self.format:
            return f"{self.productTitle} by {self.artists.artistName} ({self.format})"
        if self.productTitle and self.format:
            return f"{self.productTitle} ({self.format})"
        if self.productTitle and self.artists:
            return f"{self.productTitle} by {self.artists.artistName}"
        if self.artists and self.format:
            return f"`Missing Title` by {self.artists.artistName} ({self.format})"
        if self.format:
            return f"`Missing Title` by `Missing Artist` ({self.format})"
        return ""
    def __repr__(self):
        return f"<--- AmazonMusicProduct( {self.amazonId}: {self.productTitle} by {self.artists} ({self.format}) --->"
    def __eq__(self, other):
        if not isinstance(other, AmazonMusicProduct):
            return False
        return self.amazonId == other.amazonId
...
class AmazonMusicProductArtist:
    ...
    def __str__(self):
        return str(self.artistName) if self.artistName else ""
    def __repr__(self):
        return f"AmazonMusicProductArtist(artistName={self.artistName})"
    def __eq__(self, other):
...
class AmazonMusicProductArtistName:
    ...
    def __str__(self):
        return str(self.text)
    def __repr__(self):
        return f"AmazonMusicProductArtistName(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class AmazonMusicProductFormat:
    ...
    def __str__(self):
        return str(self.text) if self.text else ""
    def __repr__(self):
        return f"AmazonMusicProductFormat(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class AmazonMusicProductTitle:
    ...
    def __str__(self):
        return str(self.text)
    def __repr__(self):
        return f"AmazonMusicProductTitle(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class AmazonStandardId:
    ...
    def __repr__(self):
        return f"AmazonStandardId(asin={self.asin}, obfuscatedMarketplaceId={self.obfuscatedMarketplaceId}, region={self.region})"
    def __eq__(self, other):
...
class AnswerOption:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"AnswerOption(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class AppAdsInfoOutput:
    ...
    def __str__(self):
        return str(self.adLayoutSlotConfig) if self.adLayoutSlotConfig else ""
    def __repr__(self):
        return f"AppAdsInfoOutput(adLayoutSlotConfig={self.adLayoutSlotConfig}, thirdPartyAdsEligibility={self.thirdPartyAdsEligibility})"
    def __eq__(self, other):
...
class ApsConfiguration:
    ...
    def __str__(self):
        return str(self.apsSlot) if self.apsSlot else ""
    def __repr__(self):
        return f"ApsConfiguration(apsSlot={self.apsSlot}, apsSlotAdRefresh={self.apsSlotAdRefresh})"
    def __eq__(self, other):
...
class ApsSlot:
    ...
    def __str__(self):
        return self.apsSlotName
    def __repr__(self):
        return f"ApsSlot(apsSlotId={self.apsSlotId}, apsSlotName={self.apsSlotName})"
    def __eq__(self, other):
        if not isinstance(other, ApsSlot):
            return False
        return self.apsSlotId == other.apsSlotId
...
class AspectRatio:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('displayableProperty'):
            ...
            self.displayableProperty = None
    def __str__(self):
        return str(self.displayableProperty) if self.displayableProperty else ""
    def __repr__(self):
        return f"AspectRatio(aspectRatio={self.aspectRatio}, attributes={self.attributes}, displayableProperty={self.displayableProperty})"
    def __eq__(self, other):
...
class AspectRatios:
    def __init__(self, **kwargs):
        self.items = [AspectRatio(**item) for item in kwargs.get('items', [])]
    ...
    def __repr__(self):
        return f"AspectRatios(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
...
class AuthProviderDeprecationMessage:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('urls'):
            ...
            self.urls = None
    def __str__(self):
        if self.message and self.urls:
            return f"{self.message} ({self.urls})"
        elif self.message:
            return str(self.message)
        elif self.urls:
        ...
        return ""
    def __repr__(self):
        return f"AuthProviderDeprecationMessage(message={self.message}, urls={self.urls})"
    def __eq__(self, other):
...
class AuthProviderDeprecationUrl:
    ...
    def __repr__(self):
        return f"AuthProviderDeprecationUrl(label={self.label}, value={self.value})"
    def __eq__(self, other):
...
class AuthProviderDeprecationUrlLabel:
    ...
    def __str__(self):
        return str(self.text) if self.text else ""
    def __repr__(self):
        return f"AuthProviderDeprecationUrlLabel(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class AuthProviderStatus:
    ...
    def __str__(self):
        if self.provider and self.providerLinkingURL:
            return f"{self.provider} ({self.providerLinkingURL})"
        elif self.provider:
            return self.provider
        elif self.providerLinkingURL:
            return self.providerLinkingURL
        return ""
    def __repr__(self):
        return f"AuthProviderStatus(provider={self.provider}, providerLinkingURL={self.providerLinkingURL})"
    def __eq__(self, other):
...
class AwardCategory:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"AwardCategory(text={self.text})"
    def __eq__(self, other):
...
class AwardDetails:
    def __init__(self, **kwargs):
        ...
        self.text = kwargs.get('text', "")
    def __str__(self):
        if self.eventEdition and self.text:
            return f"{self.text} ({self.eventEdition})"
        return self.text
    def __repr__(self):
        return f"AwardDetails(eventEdition={self.eventEdition}, id={self.id}, text={self.text})"
    def __eq__(self, other):
...
class AwardNomination:
    ...
    def __str__(self):
        if self.award and self.category and self.id and self.winAnnouncementDate:
            return f"{self.award} - {self.category} (ID: {self.id}, Winner: {self.isWinner}, Announcement Date: {self.winAnnouncementDate})"
        if self.award and self.category and self.id:
            return f"{self.award} - {self.category} (ID: {self.id}, Winner: {self.isWinner})"
        if self.award and self.id:
            return f"{self.award} (ID: {self.id}, Winner: {self.isWinner})"
        if self.category and self.id:
            return f"{self.category} (ID: {self.id}, Winner: {self.isWinner})"
        if self.id:
            return f"ID: {self.id}, Winner: {self.isWinner}"
        return ""
    def __repr__(self):
        return f"AwardNomination(forEpisodes={self.forEpisodes}, forSongTitles={self.forSongTitles}, id={self.id}, isWinner={self.isWinner}, notes={self.notes}, winAnnouncementDate={self.winAnnouncementDate}, winningRank={self.winningRank})"
    def __eq__(self, other):
...
class AwardNominationsWithCategory:
    ...
    def __repr__(self):
        return f"AwardNominationsWithCategory(awardNominations={self.awardNominations}, category={self.category})"
    def __eq__(self, other):
...
class AwardsEvent:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('trivia'):
            ...
            self.trivia = None
        self.urls = [EventUrl(**url) for url in kwargs.get('urls', [])]
    def __str__(self):
        if self.location and self.editions:
            return f"{self.text} at {self.location} ({self.editions})"
        if self.location:
            return f"{self.text} at {self.location}"
        if self.editions:
            return f"{self.text} ({self.editions})"
        return self.text
    def __repr__(self):
        return f"AwardsEvent(id={self.id}, editions={self.editions}), location={self.location}, text={self.text}, trivia={self.trivia}, urls={self.urls}"
    def __eq__(self, other):
...
class Badge:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('title'):
            ...
            self.title = None
    def __str__(self):
        if self.title and self.subtitle and self.description:
            return f"{self.title} - {self.subtitle}: {self.description}"
        if self.title and self.subtitle:
            return f"{self.title} - {self.subtitle}"
        if self.title and self.description:
            return f"{self.title}: {self.description}"
        if self.subtitle and self.description:
            return f"{self.subtitle}: {self.description}"
        if self.title:
            return str(self.title)
        if self.subtitle:
        ...
        return ""
    def __repr__(self):
        return f"Badge(id={self.id}, description={self.description}, image={self.image}, subtitle={self.subtitle}, title={self.title})"
    def __eq__(self, other):
...
class Banner:
    ...
    def __str__(self):
        return self.url
    def __repr__(self):
        return f"Banner(attributionUrl={self.attributionUrl}, height={self.height}, imageUrl={self.imageUrl}, url={self.url}, width={self.width})"
    def __eq__(self, other):
...
class BirthName:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"BirthName(displayableProperty={self.displayableProperty}, text={self.text})"
    def __eq__(self, other):
...
class BlogLink:
    ...
    def __str__(self):
        return self.url
    def __repr__(self):
        return f"BlogLink(label={self.label}, url={self.url})"
    def __eq__(self, other):
...
class BoxOfficeAreaType:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"BoxOfficeAreaType(id={self.id}, code={self.code}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class BoxOfficeGross:
    ...
    def __str__(self):
        ...
        return ""
    def __repr__(self):
        return f"BoxOfficeGross(total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class BoxOfficeRelease:
    def __init__(self, **kwargs):
        self.titles = [Title(**title) for title in kwargs.get('titles', [])]
        self.weeksRunning = kwargs.get('weeksRunning', 0)
    def __str__(self):
        return f"{self.weeksRunning} weeks running" if self.weeksRunning else "0 weeks running"
    def __repr__(self):
        return f"BoxOfficeRelease(titles={self.titles}, weeksRunning={self.weeksRunning})"
    def __int__(self):
        return int(self.weeksRunning) if self.weeksRunning else 0
    def __float__(self):
        return float(self.weeksRunning) if self.weeksRunning else 0.0
    def __eq__(self, other):
...
class BoxOfficeWeekendChart:
    ...
    def __str__(self):
        if self.entries and self.weekendEndDate and self.weekendStartDate:
            return f"BoxOfficeWeekendChart from {self.weekendStartDate} to {self.weekendEndDate} with entries: {self.entries}"
        if self.entries:
            return f"BoxOfficeWeekendChart with entries: {self.entries}"
        if self.weekendEndDate and self.weekendStartDate:
            return f"BoxOfficeWeekendChart from {self.weekendStartDate} to {self.weekendEndDate}"
        return ""
    def __repr__(self):
        return f"BoxOfficeWeekendChart(entries={self.entries}, weekendEndDate={self.weekendEndDate}, weekendStartDate={self.weekendStartDate})"
    def __eq__(self, other):
...
class CallToActionImage:
    ...
    def __repr__(self):
        return f"CallToActionImage(caption={self.caption}, height={self.height}, url={self.url}, width={self.width})"
    def __eq__(self, other):
...
class CallToActionText:
    ...
    def __repr__(self):
        return f"CallToActionText(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class Camera:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('displayableProperty'):
            ...
            self.displayableProperty = None
    def __str__(self):
        return str(self.displayableProperty) if self.displayableProperty else self.camera
    def __repr__(self):
        return f"Camera(camera={self.camera}, attributes={self.attributes}, displayableProperty={self.displayableProperty})"
    def __eq__(self, other):
...
class Cameras:
    def __init__(self, **kwargs):
        self.items = [Camera(**item) for item in kwargs.get('items', [])]
        if kwargs.get('restriction'):
            self.restriction = TechnicalSpecificationsRestriction(**kwargs.get('restriction', {}))
        else:
            self.restriction = None
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"Cameras(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class CanRate:
    ...
    def __str__(self):
        return "CanRate" if self.isRatable else "Cannot Rate"
    def __repr__(self):
        return f"CanRate(isRatable={self.isRatable})"
    def __eq__(self, other):
...
class Certificate:
    ...
    def __str__(self):
        return self.rating
    def __repr__(self):
        return f"Certificate(id={self.id}, rating={self.rating}, ratingReason={self.ratingReason}, ratingsBody={self.ratingsBody}, ratingsBodyCertificateId={self.ratingsBodyCertificateId})"
    def __eq__(self, other):
...
class Character:
    ...
    def __str__(self):
        return self.name
    def __repr__(self):
        return f"Character(id={self.id}, name={self.name}, language={self.language})"
    def __eq__(self, other):
...
class ChartEntry:
    ...
    def __str__(self):
        return str(self.weekendGross) if self.weekendGross else ""
    def __repr__(self):
        return f"ChartEntry(title={self.title}, weekendGross={self.weekendGross})"
    def __eq__(self, other):
...
class Cinema:
    ...
    def __str__(self):
        return str(self.name) if self.name else ""
    def __repr__(self):
        return f"Cinema(id={self.id}, name={self.name}, location={self.location}, distanceToCinema={self.distanceToCinema}, contactDetails={self.contactDetails}, accessibility={self.accessibility})"
    def __eq__(self, other):
...
class CinemaAccessibility:
    ...
    def __str__(self):
        return f"Audio: {self.audioAccessibility}, Wheelchair: {self.wheelchairAccessibility}" if self.audioAccessibility or self.wheelchairAccessibility else "No Accessibility Information"
    def __repr__(self):
        return f"CinemaAccessibility(audio={self.audioAccessibility}, wheelchair={self.wheelchairAccessibility})"
    def __eq__(self, other):
...
class CinemaAudioAccessibility:
    ...
    def __str__(self):
        return "Hearing Devices Available" if self.hasHearingDevices else "No Hearing Devices"
    def __repr__(self):
        return f"CinemaAudioAccessibility(hasHearingDevices={self.hasHearingDevices})"
    def __eq__(self, other):
...
class CinemaContactDetails:
    ...
    def __str__(self):
        return self.phoneNumber if self.phoneNumber else ""
    def __repr__(self):
        return f"CinemaContactDetails(phoneNumber={self.phoneNumber})"
    def __eq__(self, other):
...
class CinemaLocation:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"CinemaLocation(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class CinemaName:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"CinemaName(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class CinemaWheelchairAccessibility:
    ...
    def __str__(self):
        return "Wheelchair Access Available" if self.hasWheelchairAccess else "No Wheelchair Access"
    def __repr__(self):
        return f"CinemaWheelchairAccessibility(hasWheelchairAccess={self.hasWheelchairAccess})"
    def __eq__(self, other):
...
class Coloration:
    ...
    def __str__(self):
        ...
        return self.text
    def __repr__(self):
        return f"Coloration(id={self.id}, attributes={self.attributes}, conceptId={self.conceptId}, displayableProperty={self.displayableProperty}, text={self.text})"
    def __eq__(self, other):
...
class Colorations:
    def __init__(self, **kwargs):
        self.items = [Coloration(**item) for item in kwargs.get('items', [])]
        if kwargs.get('restriction'):
            self.restriction = TechnicalSpecificationsRestriction(**kwargs.get('restriction', {}))
        else:
            self.restriction = None
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"Colorations(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class CommonLocalizedDisplayableConcept:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"CommonLocalizedDisplayableConcept(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class Company:
    ...
    def __str__(self):
        return str(self.companyText) if self.companyText else ""
    def __repr__(self):
        return f"Company(id={self.id}, companyText={self.companyText}, country={self.country}, images={self.images}, primaryImage={self.primaryImage}, acronyms={self.acronyms}, affiliations={self.affiliations}, bio={self.bio}, branches={self.branches}, clients={self.clients}, companyTypes={self.companyTypes}, experimental_branches={self.experimental_branches}, experimental_clients={self.experimental_clients}, keyStaff={self.keyStaff}, knownForClients={self.knownForClients}, knownForTitles={self.knownForTitles}, managedData={self.managedData}, meterRank={self.meterRank}, meterRankingHistory={self.meterRankingHistory})"
    def __eq__(self, other):
...
class CompanyAcronym:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"CompanyAcronym(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class CompanyAffiliation:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"CompanyAffiliation(id={self.id}, company={self.company}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class CompanyBio:
    ...
    def __str__(self):
        return str(self.text) if self.text else ""
    def __repr__(self):
        return f"CompanyBio(id={self.id}, displayableArticle={self.displayableArticle}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class CompanyBranch:
    ...
    def __str__(self):
        return str(self.name) if self.name else ""
    def __repr__(self):
        return f"CompanyBranch(id={self.id}, directContact={self.directContact}, name={self.name})"
    def __eq__(self, other):
...
class CompanyClient:
    def __init__(self, **kwargs):
        self.agents = [Agent(**agent) for agent in kwargs.get('agents', [])]
    ...
    def __repr__(self):
        return f"CompanyClient(id={self.id}, agents={self.agents}, client={self.client})"
    def __eq__(self, other):
...
class CompanyContactDetails:
    ...
    def __str__(self):
        ...
        if self.physicalAddress:
            return str(self.physicalAddress)
        if self.faxNumber:
            return str(self.faxNumber)
        return ""
    def __repr__(self):
        return f"CompanyContactDetails(emailAddress={self.emailAddress}, faxNumber={self.faxNumber}, phoneNumbers={self.phoneNumbers}, physicalAddress={self.physicalAddress}, website={self.website})"
    def __eq__(self, other):
...
class CountriesOfOrigin:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('language'):
            ...
            self.language = None
    def __str__(self):
        return str(self.language) if self.language else ""
    def __repr__(self):
        return f"CountriesOfOrigin(countries={self.countries}, language={self.language})"
    def __eq__(self, other):
...
class CountryAttributeMetadata:
    def __init__(self, **kwargs):
        ...
        self.validValues = [LocalizedDisplayableCountry(**validValue) for validValue in kwargs.get('validValues', [])]
    def __eq__(self, other):
...
class CountryOfOrigin:
    ...
    def __str__(self):
        ...
        return self.text if self.text else ""
    def __repr__(self):
        return f"CountryOfOrigin(id={self.id}, language={self.language}, text={self.text}, displayableProperty={self.displayableProperty})"
    def __eq__(self, other):
...
class CrazyCredit:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('text'):
            ...
            self.text = None
    def __str__(self):
        return str(self.displayableArticle) if self.displayableArticle else ""
    def __repr__(self):
        return f"CrazyCredit(id={self.id}, interestScore={self.interestScore}, text={self.text}, displayableArticle={self.displayableArticle})"
    def __eq__(self, other):
...
class CreativeSize:
    ...
    def __str__(self):
        ...
        return ""
    def __repr__(self):
        return f"CreativeSize(height={self.height}, width={self.width})"
    def __eq__(self, other):
...
class CreditAttribute:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"CreditAttribute(id={self.id}, text={self.text}, language={self.language}, SeriesCreditAttribute={self.SeriesCreditAttribute})"
    def __eq__(self, other):
...
class CreditCategory:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"CreditCategory(categoryId={self.categoryId}, id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class CreditCategorySummary:
    ...
    def __str__(self):
        return str(self.category) if self.category else ""
    def __repr__(self):
        return f"CreditCategorySummary(category={self.category}, total={self.total})"
    def __int__(self):
...
class CustomPrimaryImage:
    ...
    def __str__(self):
        return str(self.originalImage) if self.originalImage else ""
    def __repr__(self):
        return f"CustomPrimaryImage(imageEditParameters={self.imageEditParameters}, originalImage={self.originalImage})"
    def __eq__(self, other):
...
class DisplayableDateRange:
    ...
    def __str__(self):
        ...
        return ""
    def __repr__(self):
        return f"DisplayableDateRange(startDate={self.startDate}, endDate={self.endDate})"
    def __eq__(self, other):
...
class EpisodeNumberDisplayableProperty:
    ...
    def __str__(self):
        ...
        return ""
    def __repr__(self):
        return f"EpisodeNumberDisplayableProperty(value={self.value})"
    def __eq__(self, other):
...
class ExternalLink:
    ...
    def __str__(self):
        return self.url
    def __repr__(self):
        return f"ExternalLink(id={self.id}, label={self.label}, url={self.url})"
    def __eq__(self, other):
...
class Faq:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('question'):
            ...
            self.question = None
    def __str__(self):
        if self.answer and self.question:
            return f"Q: {self.question}\nA: {self.answer}"
        if self.question:
            return f"Q: {self.question}\nA: No answer provided."
        return ""
    def __repr__(self):
        return f"Faq(id={self.id}, question={self.question}, answer={self.answer}, isSpoiler={self.isSpoiler})"
    def __eq__(self, other):
...
class FileMetadata:
    ...
    def __str__(self):
        return self.name
    def __repr__(self):
        return f"FileMetadata(accountDataURL={self.accountDataURL}, creationDate={self.creationDate}, expirationDate={self.expirationDate}, name={self.name}, sizeLabel={self.sizeLabel})"
    def __eq__(self, other):
...
class FilmLength:
    ...
    def __str__(self):
        if self.displayableProperty:
            return str(self.displayableProperty)
        if self.filmLength:
            return str(self.filmLength)
        return ""
    def __repr__(self):
        return f"FilmLength(attributes={self.attributes}, countries={self.countries}, displayableProperty={self.displayableProperty}, filmLength={self.filmLength}, isSplitReel={self.isSplitReel}, numReels={self.numReels})"
    def __eq__(self, other):
...
class FilmLengths:
    def __init__(self, **kwargs):
        self.items = [FilmLength(**item) for item in kwargs.get('items', [])]
        if kwargs.get('restriction'):
            self.restriction = TechnicalSpecificationsRestriction(**kwargs.get('restriction', {}))
        else:
            self.restriction = None
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"FilmLengths(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class FilmingDates:
    def __init__(self, **kwargs):
        if kwargs.get('dateRange'):
            ...
            self.dateRange = None
    def __str__(self):
        return str(self.dateRange) if self.dateRange else ""
    def __repr__(self):
        return f"FilmingDates(dateRange={self.dateRange})"
    def __eq__(self, other):
...
class GenreItem:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"GenreItem(id={self.id}, genreId={self.genreId}, text={self.text})"
    def __eq__(self, other):
...
class GenreSummary:
    ...
    def __repr__(self):
        return f"GenreSummary(genre={self.genre}, total={self.total})"
    def __int__(self):
...
class GetLatestUIWorkflowOutput:
    def __init__(self, **kwargs):
        if kwargs.get('workflow'):
            ...
            self.workflow = None
    def __str__(self):
        return str(self.workflow) if self.workflow else ""
    def __repr__(self):
        return f"GetLatestUIWorkflowOutput(workflow={self.workflow})"
    def __eq__(self, other):
...
class GoofCategory:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"GoofCategory(id={self.id}, text={self.text})"
    def __eq__(self, other):
...
class GoofCategoryWithGoofs:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('goofs'):
            ...
            self.goofs = None
    def __str__(self):
        if self.goofs and self.category:
            return f"{self.category}: {self.goofs}"
        elif self.category:
            return f"{self.category}: []"
        return ""
    def __repr__(self):
        return f"GoofCategoryWithGoofs(category={self.category}, goofs={self.goofs})"
    def __eq__(self, other):
...
class HelpLink:
    ...
    def __str__(self):
        return str(self.url)
    def __repr__(self):
        return f"HelpLink(label={self.label}, url={self.url})"
    def __eq__(self, other):
...
class Histogram:
    ...
    def __str__(self):
        return str(self.histogramValues)
    def __repr__(self):
        return f"Histogram(demographic={self.demographic}, histogramValues={self.histogramValues})"
    def __int__(self):
        return int(self.histogramValues) if self.histogramValues else 0
    def __float__(self):
        return float(self.histogramValues) if self.histogramValues else 0.0
    def __eq__(self, other):
...
class HistogramValues:
    def __init__(self, **kwargs):
        ...
        self.voteCount = kwargs.get('voteCount', 0)
    def __str__(self):
        if self.rating and self.voteCount:
            return f"{self.rating} ({self.voteCount} votes)"
        if self.rating:
            return f"{self.rating} (votes missing)"
        if self.voteCount:
            return f"Unknown ({self.voteCount})"
        return ""
    def __repr__(self):
        return f"HistogramValues(rating={self.rating}, voteCount={self.voteCount})"
    def __int__(self):
...
class Image:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('correctionLink'):
            self.correctionLink = ContributionLink(**kwargs.get('correctionLink', {}))
        else:
            self.correctionLink = None
        if kwargs.get('countries'):
            self.countries = DisplayableCountry(**kwargs.get('countries', {}))
        else:
            self.countries = None
        ...
        if kwargs.get('languages'):
            ...
            self.languages = None
        self.names = [Name(**name) for name in kwargs.get('names', [])]
        if kwargs.get('reportingLink'):
            self.reportingLink = ContributionLink(**kwargs.get('reportingLink', {}))
        else:
            self.reportingLink = None
    ...
    def __str__(self):
        return self.url
    def __repr__(self):
        return f"<-- Image({self.id}: url={self.url}, width={self.width}, height={self.height}, caption={self.caption}, type={self.type}) -->"
    def __eq__(self, other):
...
class ImageGallery:
    def __init__(self, **kwargs):
        ...
        self.id = kwargs.get('id', "")
        self.images = [ImageConnection(**image) for image in kwargs.get('images', [])]
    def __str__(self):
        return self.galleryText
    def __repr__(self):
        return f"ImageGallery(id={self.id}, galleryText={self.galleryText}, images={self.images})"
    def __eq__(self, other):
...
class Laboratories:
    def __init__(self, **kwargs):
        self.items = [Laboratory(**item) for item in kwargs.get('items', [])]
        if kwargs.get('restriction'):
            self.restriction = TechnicalSpecificationsRestriction(**kwargs.get('restriction', {}))
        else:
            self.restriction = None
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"Laboratories(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class List:
    def __init__(self, **kwargs):
        ...
        self.items = [ListConnection(**item) for item in kwargs.get('items', [])]
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"List(areElementsInList={self.areElementsInList}, author={self.author}, createdDate={self.createdDate}, description={self.description}, id={self.id}, isElementInList={self.isElementInList}, isPredefined={self.isPredefined}, items={self.items}, lastModifiedDate={self.lastModifiedDate}, listClass={self.listClass}, listInteractionCounts={self.listInteractionCounts}, listType={self.listType}, name={self.name}, nameListItemSearch={self.nameListItemSearch}, primaryImage={self.primaryImage}, titleListItemSearch={self.titleListItemSearch}, visibility={self.visibility})"
    def __eq__(self, other):
...
class LocalizedDisplayableEpisodeNumber:
    def __init__(self, **kwargs):
        ...
        self.text = kwargs.get('text', "")
    def __str__(self):
        if str(self.text).isnumeric():
            return f"E{int(self.text):02d}"
        if str(self.episodeNumber).isnumeric():
            return f"E{int(self.episodeNumber):02d}"
        if self.text:
            return self.text
        ...
        return ""
    def __repr__(self):
        return f"LocalizedDisplayableEpisodeNumber(id={self.id}, language={self.language}, episodeNumber={self.episodeNumber}, text={self.text})"
    def __eq__(self, other):
...
class LocalizedDisplayableSeason:
    ...
    def __str__(self):
        if str(self.text).isnumeric():
            return f"S{int(self.text):02d}"
        if str(self.season).isnumeric():
            return f"S{int(self.season):02d}"
        if self.text:
            return self.text
        if self.season:
            return self.season
        return ""
    def __repr__(self):
        return f"LocalizedDisplayableSeason(id={self.id}, language={self.language}, season={self.season}, text={self.text})"
    def __eq__(self, other):
...
class ModifiedBy:
    ...
    def __str__(self):
        return self.role
    def __repr__(self):
        return f"ModifiedBy(role={self.role})"
    def __eq__(self, other):
...
class Name:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('imageUploadLink'):
            self.imageUploadLink = ContributionLink(**kwargs.get('imageUploadLink', {}))
        else:
            self.imageUploadLink = None
...
class NameRecommendations:
    def __init__(self, **kwargs):
        self.names = [NameRecommendationConnection(**name) for name in kwargs.get('names', [])]
...
class NegativeFormats:
    def __init__(self, **kwargs):
        self.items = [NegativeFormat(**item) for item in kwargs.get('items', [])]
        if kwargs.get('restriction'):
            self.restriction = TechnicalSpecificationsRestriction(**kwargs.get('restriction', {}))
        else:
            self.restriction = None
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"NegativeFormats(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class PollPrimaryImage:
    ...
    def __str__(self):
        return str(self.image) if self.image else ""
    def __repr__(self):
        return f"PollPrimaryImage(image={self.image})"
    def __eq__(self, other):
...
class PollQuestion:
    ...
    def __repr__(self):
        return f"PollQuestion(originalText={self.originalText})"
    def __eq__(self, other):
...
class PollVote:
    ...
    def __str__(self):
        if self.voteTime and self.poll and self.user and self.answerIndex:
            return f"{self.user} voted for {self.answerIndex} in poll {self.poll} at {self.voteTime}"
        if self.poll and self.user and self.answerIndex:
            return f"{self.user} voted for {self.answerIndex} in poll {self.poll}"
        if self.poll and self.user:
            return f"{self.user} voted in poll {self.poll}"
        if self.poll and self.answerIndex:
            return f"Anonymous voted for {self.answerIndex} in poll {self.poll}"
        if self.poll and self.answerIndex and self.voteTime:
            return f"Anonymous voted for {self.answerIndex} in poll {self.poll} at {self.voteTime}"
        return ""
    def __repr__(self):
        return f"PollVote(answerIndex={self.answerIndex}, poll={self.poll}, user={self.user}, voteTime={self.voteTime})"
    def __eq__(self, other):
...
class PrintedFormats:
    def __init__(self, **kwargs):
        self.items = [PrintedFormat(**item) for item in kwargs.get('items', [])]
        if kwargs.get('restriction'):
            self.restriction = TechnicalSpecificationsRestriction(**kwargs.get('restriction', {}))
        else:
            self.restriction = None
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"PrintedFormats(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class Processes:
    def __init__(self, **kwargs):
        self.items = [Process(**item) for item in kwargs.get('items', [])]
        if kwargs.get('restriction'):
            self.restriction = TechnicalSpecificationsRestriction(**kwargs.get('restriction', {}))
        else:
            self.restriction = None
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"Processes(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class RelatedNews:
    def __init__(self, **kwargs):
        self.items = [News(**item) for item in kwargs.get('items', [])]
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"RelatedNews(items={self.items})"
    def __int__(self):
        return int(len(self.items)) if self.items else 0
    def __float__(self):
        return float(len(self.items)) if self.items else 0.0
    def __eq__(self, other):
...
class RestrictionExplanation:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"RestrictionExplanation(id={self.id}, reason={self.reason}, text={self.text})"
    def __eq__(self, other):
...
class SeasonValueDisplayableProperty:
    ...
    def __str__(self):
        ...
        return ""
    def __repr__(self):
        return f"SeasonValueDisplayableProperty(value={self.value})"
    def __eq__(self, other):
...
class Series:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('series'):
            ...
            self.series = None
    def __str__(self):
        if self.series and self.displayableEpisodeNumber:
            return f"{self.series} - {self.displayableEpisodeNumber}"
        return ""
    def __repr__(self):
        return f"Series(series={self.series}, displayableEpisodeNumber={self.displayableEpisodeNumber}, nextEpisode={self.nextEpisode}, previousEpisode={self.previousEpisode}, series={self.series})"
    def __eq__(self, other):
...
class SoundMix:
    def __init__(self, **kwargs):
        ...
        self.text = kwargs.get('text', "")
    def __str__(self):
        return str(self.displayableProperty) if self.displayableProperty else self.text
    def __repr__(self):
        return f"SoundMix(id={self.id}, text={self.text}, attributes={self.attributes}, displayableProperty={self.displayableProperty})"
    def __eq__(self, other):
...
class SoundMixes:
    def __init__(self, **kwargs):
        self.items = [SoundMix(**item) for item in kwargs.get('items', [])]
        if kwargs.get('restriction'):
            self.restriction = TechnicalSpecificationsRestriction(**kwargs.get('restriction', {}))
        else:
            self.restriction = None
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"SoundMixes(items={self.items}, restriction={self.restriction}, total={self.total})"
    def __int__(self):
        return int(self.total) if self.total else 0
    def __float__(self):
        return float(self.total) if self.total else 0.0
...
class SoundtrackRestriction:
    def __init__(self, **kwargs):
        ...
        self.unrestrictedTotal = kwargs.get('unrestrictedTotal', 0)
    def __str__(self):
        return str(self.explanations) if self.explanations else "No Explanations"
    def __repr__(self):
        return f"SoundtrackRestriction(explanations={self.explanations}, reasons={self.reasons}, restrictionReason={self.restrictionReason}, unrestrictedTotal={self.unrestrictedTotal})"
    def __int__(self):
        return int(self.unrestrictedTotal) if self.unrestrictedTotal else 0
    def __float__(self):
        return float(self.unrestrictedTotal) if self.unrestrictedTotal else 0.0
    def __len__(self):
        return len(self.explanations) if self.explanations else 0
    def __eq__(self, other):
...
class Source:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"Source(attributionUrl={self.attributionUrl}, banner={self.banner}, id={self.id}, text={self.text})"
    def __eq__(self, other):
...
class SpokenLanguage:
    ...
    def __str__(self):
        ...
        return self.text
    def __repr__(self):
        return f"SpokenLanguage(displayableProperty={self.displayableProperty}, id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class SpokenLanguages:
    def __init__(self, **kwargs):
        if kwargs.get('language'):
            ...
            self.language = None
        self.spokenLanguages = [SpokenLanguage(**language) for language in kwargs.get('spokenLanguages', [])]
    def __str__(self):
        return str(self.spokenLanguages) if self.spokenLanguages else "No Spoken Languages"
    def __repr__(self):
        return f"SpokenLanguages(language={self.language}, spokenLanguages={self.spokenLanguages})"
    def __int__(self):
        return int(len(self.spokenLanguages)) if self.spokenLanguages else 0
    def __float__(self):
        return float(len(self.spokenLanguages)) if self.spokenLanguages else 0.0
    def __len__(self):
        return len(self.spokenLanguages) if self.spokenLanguages else 0
    def __eq__(self, other):
...
class SpouseAttributes:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"SpouseAttributes(id={self.id}, language={self.language}, text={self.text})"
    def __eq__(self, other):
...
class SpouseName:
    ...
    def __str__(self):
        if self.asMarkdown:
            return str(self.asMarkdown)
        if self.name:
            return str(self.name)
        return ""
    def __repr__(self):
        return f"SpouseName(asMarkdown={self.asMarkdown}, name={self.name})"
    def __eq__(self, other):
...
class StaffStatus:
    ...
    def __repr__(self):
        return f"StaffStatus(category={self.category})"
    def __eq__(self, other):
...
class StreamingTitle:
    ...
    def __str__(self):
        return self.refTag
    def __repr__(self):
        return f"StreamingTitle(refTag={self.refTag}, title={self.title})"
    def __eq__(self, other):
...
class TechnicalSpecificationsRestriction:
    def __init__(self, **kwargs):
        ...
        self.unrestrictedTotal = kwargs.get('unrestrictedTotal', 0)
    def __str__(self):
        return self.restrictionReason
    def __repr__(self):
        return f"TechnicalSpecificationsRestriction(explanations={self.explanations}, reasons={self.reasons}, restrictionReason={self.restrictionReason}, unrestrictedTotal={self.unrestrictedTotal})"
    def __int__(self):
        return int(self.unrestrictedTotal) if self.unrestrictedTotal else 0
    def __float__(self):
        return float(self.unrestrictedTotal) if self.unrestrictedTotal else 0.0
...
class Test:
    def __init__(self, **kwargs):
        ...
        self.result = kwargs.get('result', "")
        self.testItems = [TestItem(**testItem) for testItem in kwargs.get('testItems', [])]
    def __eq__(self, other):
...
class Thumbnail:
    ...
    def __str__(self):
        return self.url
    def __repr__(self):
        return f"Thumbnail(height={self.height}, url={self.url}, width={self.width})"
    def __eq__(self, other):
...
class Title:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('parentsGuideContributionLink'):
            self.parentsGuideContributionLink = ContributionLink(**kwargs.get('parentsGuideContributionLink', {}))
        else:
            self.parentsGuideContributionLink = None
        if kwargs.get('plot'):
            self.plot = Plot(**kwargs.get('plot', {}))
        else:
            self.plot = None
        if kwargs.get('plotContributionLink'):
            self.plotContributionLink = ContributionLink(**kwargs.get('plotContributionLink', {}))
        else:
            self.plotContributionLink = None
        if kwargs.get('plots'):
        ...
        if kwargs.get('releaseYear'):
            ...
            self.releaseYear = None
        if kwargs.get('reviewContributionLink'):
            self.reviewContributionLink = ContributionLink(**kwargs.get('reviewContributionLink', {}))
        else:
            self.reviewContributionLink = None
        if kwargs.get('reviews'):
        ...
        if kwargs.get('triviaContributionLink'):
            self.triviaContributionLink = ContributionLink(**kwargs.get('triviaContributionLink', {}))
        else:
            self.triviaContributionLink = None
        if kwargs.get('userRating'):
            self.userRating = Rating(**kwargs.get('userRating', {}))
        else:
            self.userRating = None
...
class TitleGenre:
    ...
    def __str__(self):
        return str(self.genre)
    def __repr__(self):
        return f"TitleGenre(genre={self.genre}, relevanceRanking={self.relevanceRanking}, subGenres={self.subGenres})"
    def __eq__(self, other):
...
class TitleGenres:
    def __init__(self, **kwargs):
        self.genres = [TitleGenre(**genre) for genre in kwargs.get('genres', [])]
    def __str__(self):
        return str(self.genres)
    def __repr__(self):
        return f"TitleGenres(genres={self.genres})"
    def __eq__(self, other):
...
class TitleMetadata:
    def __init__(self, **kwargs):
        if kwargs.get('externalLinkCategories'):
            ...
            self.externalLinkCategories = None
        self.goofCategories = [GoofCategory(**goofCategory) for goofCategory in kwargs.get('goofCategories', [])]
        self.titleConnectionCategories = [TitleConnectionCategory(**titleConnectionCategory) for titleConnectionCategory in kwargs.get('titleConnectionCategories', [])]
        self.titleGenres = [GenreItem(**titleGenre) for titleGenre in kwargs.get('titleGenres', [])]
        self.titleTypeCategories = [TitleTypeCategoryWithTitleTypes(**titleTypeCategory) for titleTypeCategory in kwargs.get('titleTypeCategories', [])]
        self.titleTypes = [TitleType(**titleType) for titleType in kwargs.get('titleTypes', [])]
    def __eq__(self, other):
...
class TitleMeterRanking:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('rankChange'):
            ...
            self.rankChange = None
    def __str__(self):
        if self.currentRank and self.meterType:
            return f"{self.currentRank} ({self.meterType})"
        if self.currentRank:
            return str(self.currentRank)
        return ""
    def __repr__(self):
        return f"TitleMeterRanking(currentRank={self.currentRank}, meterType={self.meterType}, rankChange={self.rankChange})"
    def __int__(self):
        return int(self.currentRank) if self.currentRank else 0
    def __float__(self):
        return float(self.currentRank) if self.currentRank else 0.0
    def __eq__(self, other):
...
class TrendingNameCollection:
    def __init__(self, **kwargs):
        self.items = [TrendingNameNodeConnection(**item) for item in kwargs.get('items', [])]
    ...
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"TrendingNameCollection(items={self.items}, option={self.option})"
    def __int__(self):
        return int(len(self.items)) if self.items else 0
    def __float__(self):
        return float(len(self.items)) if self.items else 0.0
...
class TrendingTitleCollection:
    def __init__(self, **kwargs):
        self.items = [TrendingTitleNodeConnection(**item) for item in kwargs.get('items', [])]
        if kwargs.get('option'):
            self.option = TrendingCollectionOption(**kwargs.get('option', {}))
        else:
            self.option = None
    def __str__(self):
        return str(self.items)
    def __repr__(self):
        return f"TrendingTitleCollection(items={self.items}, option={self.option})"
    def __int__(self):
        return int(len(self.items)) if self.items else 0
    def __float__(self):
        return float(len(self.items)) if self.items else 0.0
...
class TriviaCategory:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"TriviaCategory(id={self.id}, text={self.text})"
    def __eq__(self, other):
...
class UIWorkflow:
    ...
    def __str__(self):
        return str(self.contentHeader) if self.contentHeader else ""
    def __repr__(self):
        return f"UIWorkflow(actionTray={self.actionTray}, contentHeader={self.contentHeader}, contextHeader={self.contextHeader}, workflowState={self.workflowState}, workflowType={self.workflowType})"
    def __eq__(self, other):
...
class UIWorkflowContentHeader:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('helpLink'):
            ...
            self.helpLink = None
    def __str__(self):
        return str(self.heading) if self.heading else ""
    def __repr__(self):
        return f"UIWorkflowContentHeader(heading={self.heading}, helpLink={self.helpLink})"
    def __eq__(self, other):
...
class UserProfile:
    ...
    def __repr__(self):
        return f"UserProfile(bio={self.bio}, creationDate={self.creationDate}, primaryImage={self.primaryImage}, userId={self.userId}, username={self.username})"
    def __eq__(self, other):
...
class UserProfileUsername:
    ...
    def __str__(self):
        return self.text
    def __repr__(self):
        return f"UserProfileUsername(status={self.status}, text={self.text})"
    def __eq__(self, other):
...
class UserProfileUsernameUpdateStatus:
    def __init__(self, **kwargs):
        ...
        self.updateStatus = kwargs.get('updateStatus', "")
    def __str__(self):
        return self.updateStatus if self.updateStatus else ""
    def __repr__(self):
        return f"UserProfileUsernameUpdateStatus(lastUpdated={self.lastUpdated}, modifiedItem={self.modifiedItem}, updateFeedback={self.updateFeedback}, updateStatus={self.updateStatus})"
    def __eq__(self, other):
...
class UserReaction:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('reaction'):
            ...
            self.reaction = None
    def __str__(self):
        return str(self.reaction) if self.reaction else ""
    def __repr__(self):
        return f"UserReaction(entityId={self.entityId}, lastUpdated={self.lastUpdated}, reaction={self.reaction})"
    def __eq__(self, other):
...
class ValidationFeedback:
    ...
    def __repr__(self):
        return f"ValidationFeedback(message={self.message}, status={self.status}, title={self.title})"
    def __eq__(self, other):
...
class VanityUrl:
    ...
    def __str__(self):
        return self.url
    def __repr__(self):
        return f"VanityUrl(label={self.label}, name={self.name}, url={self.url}, urlPath={self.urlPath})"
    def __eq__(self, other):
...
class Video:
    ...
    def __str__(self):
        return str(self.thumbnail) if self.thumbnail else ""
    def __repr__(self):
        return f"Video(id={self.id}, thumbnail={self.thumbnail}, ...)"
    def __eq__(self, other):
...
class VideoContentType:
    def __init__(self, **kwargs):
        ...
        self.id = kwargs.get('id', "")
    def __str__(self):
        return str(self.displayName) if self.displayName else ""
    def __repr__(self):
        return f"VideoContentType(id={self.id}, displayName={self.displayName})"
    def __eq__(self, other):
...
class VideoDimensions:
    ...
    def __str__(self):
        ...
        return ""
    def __repr__(self):
        return f"VideoDimensions(appearance={self.appearance}, aspectRatio={self.aspectRatio}, height={self.height}, width={self.width})"
    def __eq__(self, other):
...
class VideoFacets:
    def __init__(self, **kwargs):
        self.names = [VideoNameFacet(**name) for name in kwargs.get('names', [])]
        self.titles = [VideoTitleFacet(**title) for title in kwargs.get('titles', [])]
        if kwargs.get('types'):
...
class VideoMedia:
    def __init__(self, **kwargs):
        ...
        if kwargs.get('runtime'):
            ...
            self.runtime = None
    def __str__(self):
        return str(self.primaryImage) if self.primaryImage else ""
    def __repr__(self):
        return f"VideoMedia(id={self.id}, primaryImage={self.primaryImage}, ...)"
    def __int__(self):
        return int(self.runtime) if self.runtime and self.runtime else 0
    def __float__(self):
        return float(self.runtime) if self.runtime and self.runtime else 0.0
    def __eq__(self, other):
...
class VideoRuntime:
    ...
    def __str__(self):
        ...
        return ""
    def __repr__(self):
        return f"VideoRuntime(unit={self.unit}, value={self.value})"
    def __int__(self):
        return int(self.value) if self.value else 0
    def __float__(self):
        return float(self.value) if self.value else 0.0
